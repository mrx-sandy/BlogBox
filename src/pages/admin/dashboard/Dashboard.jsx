...
function Dashboard() {
    ...
    // Check the blog data when the component renders
    useEffect(() => {
        console.log("Dashboard rendered");
        console.log("Mode:", mode);
        console.log("Number of blogs:", getAllBlog.length);
        console.log("Blog data:", getAllBlog);
    }, [mode, getAllBlog]);
                ...
                <div className="flex flex-wrap justify-start items-center lg:justify-center gap-2 lg:gap-10 px-4 lg:px-0 mb-8">
                    <div className="left">
                        <img
                            ...
                            src={'https://media.licdn.com/dms/image/D4D03AQHh7WI8f8faEg/profile-displayphoto-shrink_200_200/0/1715438915678?e=2147483647&v=beta&t=StYxmhDh5x28DCsycUU4yZFoEMOERKKRkaTdDcSljvw'}
                            alt="profile"
                        />
                    </div>
                    <div className="right">
                                ...
                                {getAllBlog.length > 0 ? (
                                    <>
                                        {getAllBlog.map((item, index) => {
                                            ...
                                            console.log("Rendering blog:", item);
                                            return (
                                                <tbody key={id}>
